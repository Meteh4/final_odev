...
import 'package:flutter_universe/sayfalar/dorduncu.dart';
import 'constants.dart';
import 'package:flutter_swiper/flutter_swiper.dart';
import 'package:flutter_universe/sayfalar/ikinci sayfa.dart';
...
Widget buildButton(BuildContext context){
  return CurvedNavigationBar(
    ...
    items: <Widget>[
      ...
      IconButton(icon: const Icon(Icons.bar_chart), iconSize: 30, onPressed: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => ucuncu())
        );
      },
      ),
      IconButton(icon: const Icon(Icons.info), iconSize: 30, onPressed: () {
        Navigator.push(
